...
| RM-20 | Frontend prácticamente no responsive | Uso difícil en pantallas de escritorio/laptop más pequeñas de lo esperado | No se amplió alcance para evitar regresiones | **Corrección (2026-08-22): no es deuda de responsive móvil.** El acceso desde dispositivos móviles está bloqueado a propósito (`#mobileBlocker`, activo en `index.html`/`login.html`) por una decisión deliberada de seguridad/política — ese bloqueo no se toca. Fase 1.1 se redefinió: el alcance real es adaptar la interfaz a distintas resoluciones de escritorio/laptop (ej. pantallas de 13"-14"), no a celulares |
...
Responsive                           = PHASE_1_1 — REDEFINIDA (2026-08-22): adaptación a resoluciones de escritorio/laptop, sin tocar el bloqueo móvil (ver RM-20)
