...
| RM-20 | Frontend prácticamente no responsive | Uso difícil en móvil | No se amplió alcance para evitar regresiones | **Corrección (2026-08-22): no es deuda técnica.** El acceso desde móvil está bloqueado a propósito (`#mobileBlocker`, activo en `index.html`/`login.html`) por una decisión deliberada de seguridad/política, no por falta de tiempo. Cualquier trabajo de adaptación responsive debe primero resolver con el dueño del control si ese bloqueo se mantiene, se relaja o se sustituye — no es un simple ajuste de CSS. Fase 1.1 queda en pausa hasta esa decisión |
...
Responsive                           = PHASE_1_1 — EN PAUSA: el acceso móvil está bloqueado a propósito por seguridad/política (ver RM-20); requiere decisión del dueño del control antes de continuar
